...
### 1. Bonferroni"
pairwise.t.test(ViagraData$libido,ViagraData$dose,p.adjust.method = "bonferroni",pooled.sd=TRUE)


#### 2. Benjamini-Hochberg 
pairwise.t.test(ViagraData$libido,ViagraData$dose,p.adjust.method = "BH", pooled.sd=TRUE)
